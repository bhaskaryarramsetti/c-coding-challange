                    ...
                    switch (mainChoice)
                    {
                        case "1":
                            ...
                            while (!donationReturn)
                            {
                                ...
                                Console.WriteLine("choose the type of your donation\n");
                                ...
                                switch (donationChoice)
                                {
                                    case "1":
                                        ...
                                        try
                                        {
                                            ...
                                            else throw new InsufficientFundsException("please enter amount greater than Rs. 1000");
                                        }
                        ...
                        case "2":
                            ...
                            {
                                Console.Clear();
                                Console.WriteLine("\t\t\tWelcome to Pets management ");
